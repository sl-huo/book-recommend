...
def main():
    ...
    with tab3:
        ### User Recommendation
        st.header('Recommend to Existing Users \n (Recommendations based on predicted rating via FunkSVD)')
        st.write('Please note that due to limited resources, here only shows a subsample. User ID is adjusted to numbers from 1 to 3300.')
